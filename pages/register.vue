...
<template>
  ...
  <div class="register-container">
    ...
    <div class="register-form">
      ...
      <button class="register-button" type="submit" @click="handleRegister" :disabled="loading">
        {{ loading ? 'Бүртгүүлж байна...' : 'Бүртгүүлэх' }}
      </button>
      
      <p class="login-link">
        Та бүртгэлтэй юу?
        <a class="link" href="/login">Нэвтрэх</a>
      </p>
    </div>
  </div>
</form>
...
const handleRegister = async () => {
  ...
  if(!isPhoneValid.value){
    alert('Утасны дугаар яг 8 оронтой байх ёстой.')
    return;
  }

  if (!form.value.phoneNumber.trim() || !form.value.password.trim()) {
    alert('Утасны дугаар болон нууц үг оруулна уу')
    return
  }
