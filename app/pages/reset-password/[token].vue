<template>
    <form @submit.prevent="handleResetPassword">
      <div class="reset-container">
        ...
        <div class="reset-form">
          ...
          <div v-if="!tokenExpired && !resetCompleted">
            <div class="input-group">
              ...
              <div class="password-input">
                <input 
                  ...
                  :class="!isPasswordValid && form.password.length > 0 ? 'inputError' : ''"
                />
            ...
            <div class="input-group">
              ...
              <div class="password-input">
                <input 
                  ...
                  :class="isConfirmPasswordValid && form.confirmPassword.length > 0 ? 'inputError' : ''"
                />
              ...
              <p v-if="isConfirmPasswordValid && form.confirmPassword.length > 0" class="error">
                Нууц үг зөрж байна.
              </p>
            </div>
  
            <button class="reset-button" type="submit" @click="handleResetPassword" :disabled="loading">
              {{ loading ? 'Шинэчилж байна...' : 'Нууц үг шинэчлэх' }}
            </button>
          </div>
          
          <div v-if="resetCompleted" class="reset-success">
            <p>Нууц үг амжилттай шинэчлэгдлээ!</p>
            <button class="reset-button" @click="goToLogin">Нэвтрэх хуудас руу очих</button>
          </div>
          
          <div v-if="tokenExpired" class="reset-expired">
            <p>Линк хүчингүй болсон байна, эсвэл нууц үг аль хэдийн шинэчлэгдсэн байна.</p>
            <p>Шинэ нууц үг шинэчлэх хүсэлт илгээнэ үү.</p>
            <button class="reset-button" @click="goToForgotPassword">Нууц үг мартсан</button>
          </div>
        </div>
      </div>
    </form>
  ...
  onMounted(async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        errorMessage.value = error.message || 'Invalid or expired token'
        return
      }
      ...
      tokenExpired.value = true
      errorMessage.value = 'Холболтын алдаа гарлаа. Дараа дахин оролдоно уу.'
    }
  })
  ...
  const validateConfirmPassword = () => {
    isConfirmPasswordValid.value = form.value.password !== form.value.confirmPassword
  }
  ...
  const handleResetPassword = async () => {
    ...
    if (!form.value.password.trim()) {
      errorMessage.value = 'Шинэ нууц үгээ оруулна уу'
      return
    }
    ...
    if (!isPasswordValid.value) {
      errorMessage.value = 'Нууц үг дор хаяж 4 тэмдэгттэй байх ёстой'
      return
    }
